...
const Culture = ({}: CultureProps) => {
  ...
  return (
    <div ref={ref} className="relative">
      <Container>
        <div className=" mx-auto p-6 space-y-10 overflow-hidden">
          {/* Headline Chính */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 bg-[#ecf5f7] p-5 group">
            ...
            <div className="">
              <img
                ...
                className="w-full h-[400px] object-cover rounded-lg transition-all duration-300 ease-in-out group-hover:brightness-75"
              />
            </div>
